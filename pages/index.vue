<template>
  <div>
    ...
    <div class="navbar-container">
      <b-navbar
        class="justify-content-between border-bottom-0 bg-white"
        toggleable="lg"
        type="light"
        data-sticky="top"
      >
        <div class="container">
              ...
              <template>
                <div>
                  <inline-svg
                    ...
                    :src="require('@/assets/img/icons/interface/cross.svg')"
                    alt="cross interface icon"
                  />
                  <inline-svg
                    class="icon navbar-toggler-open"
                    :src="require('@/assets/img/icons/interface/menu.svg')"
            ...
            <div class="py-2 py-lg-0">
              <ul class="navbar-nav">
                    ...
                    <div class="col-auto" data-dropdown-content>
                      <div class="dropdown-grid-menu">
                        ...
                        ><a
                          ...
                          class="dropdown-item fade-page"
                          >Coworking<span class="badge badge-primary ml-2"
                            >New</span
                          ></a
                        ><a
                        ...
                        ><a
                          ...
                          >Portfolio</a
                        >
                        <a href="home-saas.html" class="dropdown-item fade-page"
                          >SaaS</a
                        ><a
                        ...
                        <div class="dropdown">
                          ...
                          >
                            ...
                            <inline-svg
                              ...
                              :src="
                                require('@/assets/img/icons/interface/arrow-caret.svg')
                              "
                            ...
                            <div class="col-auto" data-dropdown-content>
                              <div class="dropdown-grid-menu">
                                ...
                                <a
                                  ...
                                  class="dropdown-item fade-page"
                                  >Confirmation - Download</a
                                ><a
                                  href="utility-confirmation-subscription.html"
                                  class="dropdown-item fade-page"
                                  >Confirmation - Subscription</a
                                ><a
                            ...
                            <div class="col-auto" data-dropdown-content>
                              <div class="dropdown-grid-menu">
                                ...
                                ><a
                                  ...
                                  class="dropdown-item fade-page"
                                  >Article Image Header</a
                                >
                                <a
                                  href="blog-article-image-header-parallax.html"
                                  class="dropdown-item fade-page"
                                  >Article Image Parallax</a
                                >
                              </div>
                            </div>
                          </div>
                ...
                <li class="nav-item dropdown">
                  ...
                  >
                  <div
                    class="dropdown-menu bg-primary-3 text-light border-bottom"
                  >
                        ...
                        <div class="list-group list-group-flush">
                          ...
                          >
                            <inline-svg
                              class="icon icon-md"
                              :src="
                                require('@/assets/img/icons/theme/files/selected-file.svg')
                              "
                          ...
                          >
                            <inline-svg
                              class="icon icon-md"
                              :src="
                                require('@/assets/img/icons/theme/communication/chat-4.svg')
                              "
                              alt="chat-4 icon"
                            />
                            <div class="text-body ml-3">
          ...
          <b-collapse
            ...
            class="justify-content-end col flex-fill px-0"
            is-nav
          >
      ...
      <section class="has-divider">
        ...
        <div class="divider">
          <inline-svg
            ...
            :src="require('@/assets/img/dividers/divider-1.svg')"
            alt="divider graphic"
          />
        </div>
      </section>
              ...
              <div class="card card-body">
                <div class="icon-round mb-3 mb-md-4 bg-primary">
                  <inline-svg
                    ...
                    :src="
                      require('@/assets/img/icons/theme/communication/chat-check.svg')
                    "
                    alt="icon"
                  />
                </div>
              ...
              <div class="card card-body">
                <div class="icon-round mb-3 mb-md-4 bg-primary">
                  <inline-svg
                    class="icon bg-primary"
                    :src="
                      require('@/assets/img/icons/theme/shopping/wallet-3.svg')
                    "
                    alt="icon"
                  />
                </div>
            ...
            <div class="col-md-4" data-aos="fade-up" data-aos-delay="300">
              <div class="card card-body">
                <div class="icon-round mb-3 mb-md-4 bg-primary">
                  <inline-svg
                    class="icon bg-primary"
                    :src="require('@/assets/img/icons/theme/food/sushi.svg')"
                    alt="icon"
                  />
                </div>
                <h4>Sushi</h4>
                  ...
                  >
                    <div class="icon-round icon-round-sm bg-primary">
                      <inline-svg
                        class="icon bg-primary"
                        :src="
                          require('@/assets/img/icons/theme/shopping/box-2.svg')
                        "
                        alt="box-2 icon"
                      />
                    </div>
                  ...
                  >
                    <div class="icon-round icon-round-sm bg-primary">
                      <inline-svg
                        class="icon bg-primary"
                        :src="
                          require('@/assets/img/icons/theme/shopping/chart-pie.svg')
                        "
                        alt="chart-pie icon"
                      />
                    </div>
                  ...
                  >
                    <div class="icon-round icon-round-sm bg-primary">
                      <inline-svg
                        class="icon bg-primary"
                        :src="
                          require('@/assets/img/icons/theme/design/saturation.svg')
                        "
                        alt="saturation icon"
                      />
                    </div>
              ...
              <div class="row mt-5 o-hidden">
                <div class="col-sm-6" data-aos="fade-left" data-aos-delay="100">
                  ...
                  >
                    <inline-svg
                      class=""
                      :src="require('@/assets/img/logos/product/invision.svg')"
                      alt="icon"
                    />
                    <div class="ml-3">
                ...
                <div class="col-sm-6" data-aos="fade-left" data-aos-delay="200">
                  ...
                  >
                    <inline-svg
                      class=""
                      :src="require('@/assets/img/logos/product/dropbox.svg')"
                      alt="icon"
                    />
                    <div class="ml-3">
                ...
                <div class="col-sm-6" data-aos="fade-left" data-aos-delay="300">
                  ...
                  >
                    <inline-svg
                      class=""
                      :src="require('@/assets/img/logos/product/slack.svg')"
                      alt="icon"
                    />
                    <div class="ml-3">
                ...
                <div class="col-sm-6" data-aos="fade-left" data-aos-delay="400">
                  ...
                  >
                    <inline-svg
                      class=""
                      :src="require('@/assets/img/logos/product/trello.svg')"
                      alt="icon"
                    />
                    <div class="ml-3">
      ...
      <section class="has-divider bg-primary-alt">
        ...
        <div class="divider">
          <inline-svg
            :src="require('@/assets/img/dividers/divider-2.svg')"
        ...
        <div class="container">
                    ...
                    <td class="bg-primary-alt">
                      <div class="icon-round icon-round-xs bg-success">
                        <inline-svg
                          class="icon bg-light"
                          :src="
                            require('@/assets/img/icons/interface/check.svg')
                          "
          ...
          <div class="row justify-content-center mt-6">
            <div class="col-xl-7 col-lg-8 col-md-10">
              <client-only>
                <Flickity :options="{ imagesLoaded: true, wrapAround: true }">
                  <div class="carousel-cell mx-md-4">
                    <div class="card card-body flex-row py-4">
                      ...
                      <div class="ml-3">
                        <h4>
                          &ldquo;The team were only too happy to help me getting
                          started.&rdquo;
                        </h4>
                  ...
                  <div class="carousel-cell mx-md-4">
                    <div class="card card-body flex-row py-4">
                      ...
                      <div class="ml-3">
                        <h4>
                          &ldquo;Once again, my expectations have been surpassed
                          – Bravo!&rdquo;
                        </h4>
                        <div class="avatar-author d-block">
                  ...
                  <div class="carousel-cell mx-md-4">
                    <div class="card card-body flex-row py-4">
                      ...
                      <div class="ml-3">
                        <h4>
                          &ldquo;What usually takes at least 2 or 3 weeks was
      ...
      <section class="bg-primary text-light has-divider">
        <div class="divider flip-y">
          <inline-svg
            :src="require('@/assets/img/dividers/divider-3.svg')"
            alt="graphical divider"
          />
        </div>
        <div class="container">
          ...
          <div class="row justify-content-center text-center">
            <div class="col-xl-6 col-lg-7 col-md-9">
              <form class="d-md-flex mb-3 justify-content-center">
                ...
                />
                <button class="mx-1 btn btn-primary-3 btn-lg" type="submit">
                  Get Started
                </button>
              </form>
      ...
      <footer id="footer" class="pb-4 bg-primary-3 text-light">
        <div class="container">
          <div class="row mb-5">
            <div class="col">
              <div
              ...
              >
                ...
                <div class="decoration layer-0">
                  <inline-svg
                    class="bg-primary-2"
                    :src="require('@/assets/img/decorations/deco-blob-1.svg')"
            ...
            <div class="col-6 col-lg">
              ...
              <ul class="list-unstyled">
                <li class="mb-3 d-flex">
                  <inline-svg
                    class="icon"
                    :src="require('@/assets/img/icons/theme/map/marker-1.svg')"
                    alt="marker-1 icon"
                  />
                  <div class="ml-3">
                ...
                <li class="mb-3 d-flex">
                  <inline-svg
                    class="icon"
                    :src="
                      require('@/assets/img/icons/theme/communication/call-1.svg')
                    "
                    alt="call-1 icon"
                  />
                  <div class="ml-3">
                ...
                <li class="mb-3 d-flex">
                  <inline-svg
                    class="icon"
                    :src="
                      require('@/assets/img/icons/theme/communication/mail.svg')
                    "
                    alt="mail icon"
                  />
                  <div class="ml-3">
                  ...
                  <div class="col-12">
                    ...
                    >
                      <inline-svg
                        class="icon"
                        :src="
                          require('@/assets/img/icons/theme/code/loading.svg')
                        "
                        alt="loading icon"
                      />
                      <span>Subscribe</span>
              ...
              <ul class="nav">
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <inline-svg
                      class="icon"
                      :src="require('@/assets/img/icons/social/twitter.svg')"
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <inline-svg
                      class="icon"
                      :src="require('@/assets/img/icons/social/youtube.svg')"
                ...
                <li class="nav-item">
                  <a href="#" class="nav-link">
                    <inline-svg
                      class="icon"
                      :src="require('@/assets/img/icons/social/medium.svg')"
          ...
          <div class="row justify-content-center">
            <div class="col col-md-auto text-center">
              <small class="text-muted"
                >&copy;2020 This page is protected by reCAPTCHA and is subject
                to the Google
...
export default {
  components: {
    ...
    Flickity: () => import('@/components/Flickity.vue'),
  },
}
</script>
